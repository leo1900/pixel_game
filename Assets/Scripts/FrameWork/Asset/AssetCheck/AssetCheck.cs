...
namespace FrameWork.Asset
{
    public class AssetCheck : MonoBehaviour
    {
        ...
        IEnumerator CheckInitPackage()
        {
            ...
            {
                List<string> temp = group.GetInInitialPacketPaths(true);
                temp.AddRange(group.GetInInitialPacketPaths(false));
        ...
        public static void CheckStart()
        {
            ...
            {
                EventManager.Instance.Trigger<SDKEvents.ConfirmWindowEvent>().Data(new ConfirmWindowEvent.UIData()
                {
