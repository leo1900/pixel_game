...
namespace FrameWork.Asset
{
    public static partial class BuildAssetBundles
    {
        ...
        public static void BuildAllActivityAssetBundleWithJenkinsStyle()
        {
            ...
            DebugUtil.Log("BuildAllActivityAssetBundle finish");
        }
        
        public static void BuildAllAssetBundleBindCommitIDWithJenkinsStyle()
        {
        ...
        public static string GetCommitID()
        {
            ...
            process.StartInfo.Arguments = Application.dataPath + "/../../BuildTools/GetCommitId.sh";
            process.StartInfo.RedirectStandardOutput = true;
            process.StartInfo.RedirectStandardInput = true;
            process.StartInfo.WorkingDirectory = Application.dataPath + "/../../";
            process.Start();
            string commitId = process.StandardOutput.ReadToEnd();
            process.WaitForExit();
            process.Close();
        ...
        public static string GenerateUniqueCommitID()
        {
            string commitId = GetCommitID();

            commitId = commitId.Substring(0, 8);
            
            string rand = System.Guid.NewGuid().ToString().Replace("-", "");
            rand = rand.Substring(0, 16);
            
            Debug.Log(commitId + "_" + rand);

            return commitId + "_" + rand;
        }
    }
}